      ...
      <div className="min-h-screen bg-neutral bg-opacity-90 relative p-4 md:p-12 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex flex-col items-start w-[100%] md:w-[70%]">
          ...
          <div className="flex items-center gap-6 mb-4">
            ...
            >
              <span
                className={`rounded-full w-14 h-14 bg-neutral text-white font-semibold flex items-center justify-center border-2 p-2 ${thisMovie?.show?.rating?.average > 5 ? "border-success" : "border-error"
                  }`}
              >
